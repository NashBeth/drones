...
Route::group(['prefix'  =>  'admin'], function () {
    ...
    Route::group(['prefix'  =>   'industries'], function () {
        Route::get('/', [IndustryController::class, 'index'])->name('admin.industries.index');
        Route::get('/create', [IndustryController::class, 'create'])->name('admin.industries.create');
        Route::post('/store', [IndustryController::class, 'store'])->name('admin.industries.store');
        Route::get('/{id}/edit', [IndustryController::class, 'edit'])->name('admin.industries.edit');
        Route::post('/update', [IndustryController::class, 'update'])->name('admin.industries.update');
        Route::get('/{id}/delete', [IndustryController::class, 'delete'])->name('admin.industries.delete');
    });
