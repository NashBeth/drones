...
@endsection
@push('scripts')
    <script src="{{ asset('../../../../backend/js/jquery-2.0.0.min.js') }}" type="text/javascript"></script>
    <script type="text/javascript" src="{{ asset('../../../../backend/js/plugins/select2.min.js') }}"></script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.9.2/min/dropzone.min.js">
    </script>
